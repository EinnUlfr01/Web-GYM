...
export interface CustomerShopOrder { id:number; shop:OrderShopSummary; status:ShopOrderStatus; subtotal:number; createdAt:Date; updatedAt:Date; items:CustomerOrderItem[] }
