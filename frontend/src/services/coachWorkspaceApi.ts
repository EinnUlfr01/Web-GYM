...
const coach = '/coach';
export const getCoachDashboard = async () => data<CoachDashboardData>(await api.get(`${coach}/dashboard`));
export const listCoachExercises = async (params:Record<string,unknown>) => page<CoachExercise>(await api.get(`${coach}/exercises`, { params }));
export const getCoachExercise = async (id:number) => data<CoachExercise>(await api.get(`${coach}/exercises/${id}`));
export const listPrograms = async (params:Record<string,unknown>) => page<CoachProgram>(await api.get(`${coach}/workout-programs`, { params }));
...
export const listSchedules = async (params:Record<string,unknown>) => page<CoachSchedule>(await api.get(`${coach}/schedules`, { params }));
