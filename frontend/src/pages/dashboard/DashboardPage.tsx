...
export default function DashboardPage() {
  ...
  const loadBookings = useCallback(() => { setBookingsLoading(true); setBookingsError(''); return getMyBookings({ limit: 100 }).then(setBookings).catch((reason: unknown) => setBookingsError(messageFor(reason, 'Không thể tải lịch hẹn.'))).finally(() => setBookingsLoading(false)); }, []);
