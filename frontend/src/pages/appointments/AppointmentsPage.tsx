...
export default function AppointmentsPage() {
  ...
  const cancel = async (id: number) => { const updated = await cancelMyBooking(id); setBookings(current => current.map(booking => booking.id === id ? updated : booking)); return updated; };
