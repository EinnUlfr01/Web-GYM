...
export interface CoachProgressSession { id:number; started_at:string; completed_at?:string|null; ended_at?:string|null; status:string; workout_name?:string; program_name?:string; day_title?:string; total_duration_seconds?:number|null; scheduled_date?:string; }
