...
export interface CustomerShopOrder { id:number;shop:{id:number;name:string;slug:string};status:ShopOrderStatus;subtotal:number;createdAt:string;updatedAt:string;items:CustomerOrderItem[] }
